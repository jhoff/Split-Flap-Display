...
typedef enum {
  JST_STR, JST_INT, JST_FLOAT, JST_INT_VECTOR
} JsonSettingType;
...
class JsonSetting {
  public:
    ...
    JsonSetting(std::vector<int> intVectorDefault) : type(JsonSettingType::JST_INT_VECTOR), intVectorDefault(intVectorDefault) {
